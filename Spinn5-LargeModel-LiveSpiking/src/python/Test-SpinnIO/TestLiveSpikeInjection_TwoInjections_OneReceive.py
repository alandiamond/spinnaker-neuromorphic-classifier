...
if numArgumentsProvided == 9 :
    ...
    hostReceivePortPop1 = int(sys.argv[7])
    spikeReceivePopLabel1  = sys.argv[8]
    runTimeMs = int(sys.argv[9])
else:
    print 'usage: ', sys.argv[0] , ' <spikeInjectionPort1> <spikeInjectionPopLabel1> <nNeurons1> <spikeInjectionPort2> <spikeInjectionPopLabel2>  <nNeurons2> <hostReceivePortPop1> <spikeReceivePopLabel1> <runTimeMs>'
    sys.exit(0)
